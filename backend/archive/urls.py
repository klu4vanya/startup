...
urlpatterns = [
    ...
    path('illness-pictures/', IllnessPictureViewSet.as_view({'get': 'list', 'post': 'create'}), name='illness-pictures'),
    path('illness-pictures/<int:pk>', IllnessPictureViewSet.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'}), name='illness-picture'),
]
