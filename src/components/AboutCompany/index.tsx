...
export default function AboutCompany() {
    return (
        ...
        >
            ...
            >
                CALADRIUS -  является ведущим разработчиком программных решений, предназначенных для преобразования традиционных методов патоморфологической диагностики в цифровой формат. Наша миссия заключается в создании инновационных инструментов, которые способствуют улучшению качества медицинских услуг.
            </MainSubitle>
            <StyledMainTitle>
                Наши решения
            </StyledMainTitle>
